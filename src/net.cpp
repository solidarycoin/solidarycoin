...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Solidarycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"solidarycointools.com", "dnsseed.solidarycointools.com"},
    {"solidarycoinpool.org", "dnsseed.solidarycoinpool.org"},
    {"xurious.com", "dnsseed.sol.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"solidarycointools.com", "testnet-seed.solidarycointools.com"},
    {"xurious.com", "testnet-seed.sol.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Solidarycoin is probably already running."), addrBind.ToString().c_str());
        else
